...
CREATE TABLE reporting.previous_application(
    ...
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/previous_application/';
...
Create table reporting.application_train(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/application_train/';
...
SK_DPD_DEF double
  ...
  LOCATION
  'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/credit_card_balance/'; 
...
Create table reporting.bureau_balance(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/bureau_balance/';
...
create table reporting.bureau(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/bureau/';
...
Create table reporting.pos_cash_balance(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/pos_cash_balance/';
...
Create table reporting.installments_payments(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/installments_payments/';
...
Create table reporting.pii_list(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/pii_list/';
...
Create table reporting.pii_statistics(
    ...
    STORED AS ORC
    LOCATION
    'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/pii_statistics/';
