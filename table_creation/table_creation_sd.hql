...
!echo "########## Start : previous_application - external table creation in raw database"; 

CREATE external TABLE raw.previous_application(
    sk_id_prev double,
    sk_id_curr double,
    ...
    STORED AS ORC
    LOCATION
    's3://octank-datalake-seba/raw/home_loan/previous_application/';

!echo "########## End   : previous_application - external table creation in raw database"; 
...
CREATE TABLE staging.previous_application(
    ...
    LOCATION 's3://octank-datalake-seba/staging/home_loan/previous_application/'
    TBLPROPERTIES ( 
        'transactional'='true',
...
CREATE TABLE standardization.previous_application(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/previous_application'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert previous application data from external to staging table"; 
Insert into staging.previous_application select * from raw.previous_application;
!echo "########## End   : Insert previous_application data from external to staging table"; 
...
!echo "########## Start : application_train - external table creation in raw database"; 
Create external table raw.application_train(
    sk_id_curr double,
    target double,
    name_contract_type varchar(256),
    ...
    STORED AS ORC
    LOCATION
    's3://octank-datalake-seba/raw/home_loan/application_train/';
!echo "########## End   : application_train - external table creation in raw database"; 
...
create table staging.application_train(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/application_train/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
    );
!echo "########## End   : application_train - table creation in staging table"; 
...
create table standardization.application_train(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/application_train/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert application_train data from external to staging table"; 
Insert into staging.application_train select * from raw.application_train;
...
!echo "########## Start : credit_card_balance - external table creation in raw database"; 
Create external table raw.credit_card_balance(
SK_ID_PREV double,
SK_ID_CURR double,
...
SK_DPD_DEF double
  ...
  LOCATION
  's3://octank-datalake-seba/raw/home_loan/credit_card_balance/';

!echo "########## End   : credit_card_balance - external table creation in raw database"; 
...
Create table staging.credit_card_balance(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/credit_card_balance/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
Create table standardization.credit_card_balance(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/credit_card_balance/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert credit_card_balance data from external to staging table"; 
Insert into staging.credit_card_balance select * from raw.credit_card_balance;
!echo "########## End   : Insert credit_card_balance data from external to staging table"; 
...
!echo "Start : bureau_balance - external table creation in raw database"; 
Create external table raw.bureau_balance(
    SK_ID_BUREAU double,
    MONTHS_BALANCE double,
    STATUS varchar(256))
    STORED AS ORC
    LOCATION
    's3://octank-datalake-seba/raw/home_loan/bureau_balance/';

!echo "########## End   : bureau_balance - external table creation in raw database"; 
...
Create table staging.bureau_balance(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/bureau_balance_orc/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
    );
!echo "########## End   : bureau_balance - ACID table creation in staging database"; 
...
Create table standardization.bureau_balance(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/bureau_balance/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert bureau_balance data from external to staging table"; 
Insert into staging.bureau_balance select * from raw.bureau_balance;
...
!echo "########## Start : bureau - external table creation in raw"; 

create external table raw.bureau(
    sk_id_curr double,
    sk_id_bureau double,
    ...
    STORED AS ORC
    LOCATION
    's3://octank-datalake-seba/raw/home_loan/bureau/';

!echo "########## End   : bureau - external table creation in raw"; 
...
create table staging.bureau(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/bureau/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
create table standardization.bureau(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/bureau/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert bureau data from external to staging table"; 
Insert into staging.bureau select * from raw.bureau;
!echo "########## End   : Insert bureau data from external to ACID table"; 
...
!echo "########## Start : pos_cash_balance - external table creation in raw"; 
Create external table raw.pos_cash_balance(
    SK_ID_PREV double,
    SK_ID_CURR double,
    MONTHS_BALANCE double,
    ...
    STORED AS ORC
    LOCATION
    's3://octank-datalake-seba/raw/home_loan/pos_cash_balance/';
!echo "########## End   : pos_cash_balance - external table creation in raw"; 


!echo "########## Start : pos_cash_balance - table creation in stage"; 
...
Create table staging.pos_cash_balance(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/pos_cash_balance/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
    );
!echo "########## End   : pos_cash_balance - table creation in stage"; 
...
Create table standardization.pos_cash_balance(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/pos_cash_balance/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert pos_cash_balance data from external to staging table"; 
Insert into staging.pos_cash_balance select * from raw.pos_cash_balance;
!echo "########## End   : Insert pos_cash_balance data from external to staging table"; 
...
!echo "########## Start : installments_payments - external table creation in raw"; 
Create external table raw.installments_payments(
    SK_ID_PREV double,
    SK_ID_CURR double,
    ...
    STORED AS ORC
    LOCATION
    's3://octank-datalake-seba/raw/home_loan/installments_payments/';

!echo "########## End   : installments_payments - external table creation in raw"; 



!echo "########## Start : installments_payments - table creation in staging"; 
...
Create table staging.installments_payments(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/installments_payments/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
Create table standardization.installments_payments(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/installments_payments/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "########## Start : Insert installments_payments data from external to staging table"; 
Insert into staging.installments_payments select * from raw.installments_payments;
!echo "########## End   : Insert installments_payments data from external to staging table"; 
...
!echo "########## Start : pii_list - external table creation in raw"; 
Create external table raw.pii_list(
    ID double)
STORED AS ORC
LOCATION
's3://octank-datalake-seba/raw/home_loan/pii_list/';
!echo "########## End   : pii_list - external table creation in raw"; 
...
Create table staging.pii_list(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 's3://octank-datalake-seba/staging/home_loan/pii_list/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
Create table standardization.pii_list(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/pii_list/'
    TBLPROPERTIES ( 
        'transactional'='true',
        'transactional_properties'='default',
        'transient_lastDdlTime'='1555090610'
...
!echo "Start : Insert pii_list data from external to staging table"; 
Insert into staging.pii_list select * from raw.pii_list;
!echo "########## End   : Insert pii_list data from external to staging table"; 
...
Create table standardization.pii_statistics(
    ...
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
    OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs://ip-10-0-0-160.ap-northeast-2.compute.internal:8020/octank_datalake/home_loan/standardization/pii_statistics/'
    TBLPROPERTIES ( 
    'transactional'='true',
    'transactional_properties'='default',
    'transient_lastDdlTime'='1555090610'
